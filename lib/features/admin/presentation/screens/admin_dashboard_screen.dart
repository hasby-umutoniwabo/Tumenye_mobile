      ...
      body: SafeArea(child: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(child: Padding(
          ...
          child: Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            ...
            const SizedBox(height:12),
            _actRow(context,'Jean Bosco earned Silver Badge','3 hrs ago',Icons.emoji_events,AppColors.accentYellow),
            _actRow(context,'Divine M. completed Module 4 Quiz','5 hrs ago',Icons.check_circle_outline,AppColors.primary),
            _actRow(context,'New Student joined Grade 9 - Huye','5 hrs ago',Icons.person_add_outlined,AppColors.accentBlue),
          ]))),
...
Widget _actRow(BuildContext context, String text, String time, IconData icon, Color color) {
  return Container(
