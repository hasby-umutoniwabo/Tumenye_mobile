      ...
      body: SafeArea(child: CustomScrollView(slivers: [
        SliverToBoxAdapter(child: Padding(
          ...
          child: Row(children: [
            ...
            Expanded(child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
              Text('Muraho, Teacher',style:Theme.of(context).textTheme.bodySmall?.copyWith(color:AppColors.textSecondary)),
              Text('Admin Dashboard',style:Theme.of(context).textTheme.bodyLarge?.copyWith(fontWeight:FontWeight.w700)),
            ])),
        ...
        SliverToBoxAdapter(child:Padding(
          ...
          child:ElevatedButton.icon(onPressed:(){},
            icon:const Icon(Icons.add,size:18),label:const Text('Quick Assign Lesson'),
        ...
        SliverToBoxAdapter(child:Padding(
          ...
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,children:[
              Text('Class Groups',style:Theme.of(context).textTheme.headlineSmall?.copyWith(fontSize:16)),
              const Text('View All',style:TextStyle(fontSize:12,fontWeight:FontWeight.w600,color:AppColors.primary)),
            ]),
        ...
        SliverToBoxAdapter(child:Padding(
          padding:const EdgeInsets.symmetric(horizontal:20),
          child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
            Text('Recent Activity',style:Theme.of(context).textTheme.headlineSmall?.copyWith(fontSize:16)),
            const SizedBox(height:12),
            _Act('Jean Bosco earned Silver Badge','3 hrs ago',Icons.emoji_events,AppColors.accentYellow),
            _Act('Divine M. completed Module 4 Quiz','5 hrs ago',Icons.check_circle_outline,AppColors.primary),
            _Act('New Student joined Grade 9 - Huye','5 hrs ago',Icons.person_add_outlined,AppColors.accentBlue),
          ]))),
      ...
      bottomNavigationBar:Container(
        ...
        child:SafeArea(child:SizedBox(height:64,child:Row(
          ...
          children:const[
            ...
            _Nav(Icons.menu_book_outlined,'Curriculum',false),
            _Nav(Icons.people_outline,'Students',false),
            _Nav(Icons.settings_outlined,'Settings',false),
          ])))),
    );
  }
}
...
class _Stat extends StatelessWidget {
  final String label,value; final String? change; final Color color;
    ...
    child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
      ...
      Row(crossAxisAlignment:CrossAxisAlignment.end,children:[
        ...
        if(change!=null)...[const SizedBox(width:6),
          Text(change!,style:const TextStyle(fontSize:12,color:Colors.white70))],
      ]),
    ]));
}

class _ClassCard extends StatelessWidget {
  final String name,sub; final int score; final Color color;
  ...
  Widget build(BuildContext context)=>Container(
    ...
    child:Column(crossAxisAlignment:CrossAxisAlignment.start,children:[
      SizedBox(width:46,height:46,child:Stack(alignment:Alignment.center,children:[
        ...
        Text('$score%',style:TextStyle(fontSize:10,fontWeight:FontWeight.w700,color:color)),
      ])),
      const Spacer(),
...
Widget _Act(String text,String time,IconData icon,Color color)=>Container(
...
class _Nav extends StatelessWidget {
  ...
  Widget build(BuildContext context)=>Column(mainAxisAlignment:MainAxisAlignment.center,children:[
    Icon(icon,color:active?AppColors.accentBlue:AppColors.textHint,size:22),
    const SizedBox(height:2),
    Text(label,style:TextStyle(fontSize:10,color:active?AppColors.accentBlue:AppColors.textHint,
