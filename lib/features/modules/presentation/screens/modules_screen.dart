            ...
            children: [
              Row(
                  ...
                  children: [
                    Container(
                        ...
                        child: Icon(_icon(),
                            color:
                                locked ? AppColors.textHint : color,
                            size: 22)),
              ...
              Text(module.subtitle,
                  style: TextStyle(
                      ...
                      color:
                          locked ? AppColors.accentRed : color)),
...
class _RecentActivity extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final items = [
      ('Keyboard Layouts', 'Microsoft Word • 80% Complete', 0.80,
          AppColors.accentBlue),
      ('Sum & Averages', 'Microsoft Excel • 20% Complete', 0.20,
          AppColors.primary),
    ];
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20),
